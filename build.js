...
(async () => {
            ...
            action.params.forEach((param) => {
                ...
                if (param.type === "combo") {
                    ...
                    param.items.forEach((item) => {
                        ...
                        root.actions[key].params[param.id].items[itemkey] =
                            item[itemkey];
                    });
                }
            });
    ...
    let editorPluginInfo = getEditorPluginInfoFromConfig(config);
