    ...
    function AsyncIterator(t, e) {
        function invoke(r, o, i, a) {
            ...
            if ("throw" !== c.type) {
                var u = c.arg,
                    h = u.value;
                return h && "object" == _typeof2(h) && n.call(h, "__await")
    ...
    return function (effekseer_native) {
        ...
        ENVIRONMENT_IS_NODE =
            (typeof process === "undefined"
                ? "undefined"
                : _typeof2(process)) === "object" &&
            _typeof2(process.versions) === "object" &&
        ...
        function _emscripten_set_main_loop_timing(mode, value) {
            ...
            if (mode == 0) {
                ...
                if (typeof setImmediate === "undefined") {
                    ...
                    var Browser_setImmediate_messageHandler =
        ...
        var Browser = {
                ...
                runIter: function runIter(func) {
                    ...
                    try {
                        ...
                        if (e instanceof ExitStatus) {
                            ...
                            if (e && _typeof2(e) === "object" && e.stack)
            ...
            destroyContext: function destroyContext(
                canvas,
                useWebGL,
                setInModule
            ) {},
            ...
            safeRequestAnimationFrame: function safeRequestAnimationFrame(
                func
            ) {
            ...
            updateCanvasDimensions: function updateCanvasDimensions(
                canvas,
                wNative,
                hNative
            ) {
        ...
        var AL = {
            ...
            freeIds: [],
            scheduleContextAudio: function scheduleContextAudio(ctx) {
                if (
                    Browser.mainLoop.timingMode === 1 &&
            ...
            scheduleSourceAudio: function scheduleSourceAudio(src, lookahead) {
                if (
                    Browser.mainLoop.timingMode === 1 &&
                    document["visibilityState"] != "visible"
                ) {
            ...
            updateSourceTime: function updateSourceTime(src) {
            ...
            initSourcePanner: function initSourcePanner(src) {
                if (src.type === 4144) {
                    return;
                }
            ...
            updateContextGlobal: function updateContextGlobal(ctx) {
                for (var i in ctx.sources) {
                    AL.updateSourceGlobal(ctx.sources[i]);
                }
            },
            updateSourceGlobal: function updateSourceGlobal(src) {
            ...
            updateListenerSpace: function updateListenerSpace(ctx) {
            ...
            updateSourceSpace: function updateSourceSpace(src) {
                if (!src.panner) {
                    return;
                }
                var panner = src.panner;
                ...
                if (src.relative) {
                    ...
                    var inverseMagnitude = function inverseMagnitude(x, y, z) {
            ...
            updateSourceRate: function updateSourceRate(src) {
                if (src.state === 4114) {
            ...
            sourceDuration: function sourceDuration(src) {
                var length = 0;
                for (var i = 0; i < src.bufQueue.length; i++) {
            ...
            sourceTell: function sourceTell(src) {
                AL.updateSourceTime(src);
                var offset = 0;
            ...
            sourceSeek: function sourceSeek(src, offset) {
            ...
            getGlobalParam: function getGlobalParam(funcname, param) {
                if (!AL.currentCtx) {
                    return null;
                }
                switch (param) {
            ...
            setGlobalParam: function setGlobalParam(funcname, param, value) {
                if (!AL.currentCtx) {
                    return;
                }
                switch (param) {
            ...
            getListenerParam: function getListenerParam(funcname, param) {
                if (!AL.currentCtx) {
                    return null;
                }
                switch (param) {
            ...
            setListenerParam: function setListenerParam(
                funcname,
                param,
                value
            ) {
            ...
            getBufferParam: function getBufferParam(funcname, bufferId, param) {
                if (!AL.currentCtx) {
                    return;
                }
            ...
            setBufferParam: function setBufferParam(
                funcname,
                bufferId,
                param,
                value
            ...
            getSourceParam: function getSourceParam(funcname, sourceId, param) {
                if (!AL.currentCtx) {
                    return null;
                }
            ...
            setSourceParam: function setSourceParam(
                funcname,
                sourceId,
                param,
                value
            ...
            requireValidCaptureDevice: function requireValidCaptureDevice(
                deviceId,
                funcname
            ) {
                if (deviceId === 0) {
        ...
        var GL = {
            ...
            registerContext: function registerContext(
                ctx,
                webGLContextAttributes
            ) {
            ...
            deleteContext: function deleteContext(contextHandle) {
                ...
                if (
                    (typeof JSEvents === "undefined"
                        ? "undefined"
                        : _typeof2(JSEvents)) === "object"
                )
        ...
        function _emscripten_glGetActiveAttrib(
            ...
            var numBytesWrittenExclNull =
                bufSize > 0 && name
                    ? stringToUTF8(info.name, name, bufSize)
                    : 0;
        ...
        function _emscripten_glGetUniformLocation(program, name) {
            ...
            if (name[name.length - 1] == "]") {
                ...
                arrayIndex =
                    name[leftBrace + 1] != "]"
                        ? jstoi_q(name.slice(leftBrace + 1))
                        : 0;
                name = name.slice(0, leftBrace);
            }
            var uniformInfo =
                GL.programInfos[program] &&
                GL.programInfos[program].uniforms[name];
        ...
        function emscriptenWebGLGetUniform(program, location, params, type) {
            ...
            if (typeof data == "number" || typeof data == "boolean") {
                switch (type) {
                    ...
                    default:
                        throw (
                            "internal emscriptenWebGLGetUniform() error, bad type: " +
                            type
                        );
                }
            } else {
        ...
        var _EffekseerBeginUpdate = (Module["_EffekseerBeginUpdate"] =
            function () {
                return (_EffekseerBeginUpdate = Module[
                    "_EffekseerBeginUpdate"
                ] =
                    Module["asm"]["EffekseerBeginUpdate"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var _EffekseerUpdateHandle = (Module["_EffekseerUpdateHandle"] =
            function () {
                return (_EffekseerUpdateHandle = Module[
                    "_EffekseerUpdateHandle"
                ] =
                    Module["asm"]["EffekseerUpdateHandle"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var _EffekseerDrawHandle = (Module["_EffekseerDrawHandle"] =
            function () {
                return (_EffekseerDrawHandle = Module["_EffekseerDrawHandle"] =
                    Module["asm"]["EffekseerDrawHandle"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetProjectionMatrix = (Module[
            ...
            return (_EffekseerSetProjectionMatrix = Module[
                ...
                Module["asm"]["EffekseerSetProjectionMatrix"]).apply(
                null,
                arguments
            );
        });
        ...
        var _EffekseerSetCameraMatrix = (Module["_EffekseerSetCameraMatrix"] =
            function () {
                return (_EffekseerSetCameraMatrix = Module[
                    ...
                    Module["asm"]["EffekseerSetCameraMatrix"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetCameraLookAt = (Module["_EffekseerSetCameraLookAt"] =
            function () {
                return (_EffekseerSetCameraLookAt = Module[
                    ...
                    Module["asm"]["EffekseerSetCameraLookAt"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerLoadEffect = (Module["_EffekseerLoadEffect"] =
            function () {
                return (_EffekseerLoadEffect = Module["_EffekseerLoadEffect"] =
                    Module["asm"]["EffekseerLoadEffect"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerReleaseEffect = (Module["_EffekseerReleaseEffect"] =
            function () {
                return (_EffekseerReleaseEffect = Module[
                    "_EffekseerReleaseEffect"
                ] =
                    Module["asm"]["EffekseerReleaseEffect"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerReloadResources = (Module["_EffekseerReloadResources"] =
            function () {
                return (_EffekseerReloadResources = Module[
                    ...
                    Module["asm"]["EffekseerReloadResources"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerStopAllEffects = (Module["_EffekseerStopAllEffects"] =
            function () {
                return (_EffekseerStopAllEffects = Module[
                    "_EffekseerStopAllEffects"
                ] =
                    Module["asm"]["EffekseerStopAllEffects"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerPlayEffect = (Module["_EffekseerPlayEffect"] =
            function () {
                return (_EffekseerPlayEffect = Module["_EffekseerPlayEffect"] =
                    Module["asm"]["EffekseerPlayEffect"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerStopEffect = (Module["_EffekseerStopEffect"] =
            function () {
                return (_EffekseerStopEffect = Module["_EffekseerStopEffect"] =
                    Module["asm"]["EffekseerStopEffect"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var _EffekseerSetLocation = (Module["_EffekseerSetLocation"] =
            function () {
                return (_EffekseerSetLocation = Module[
                    "_EffekseerSetLocation"
                ] =
                    Module["asm"]["EffekseerSetLocation"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetRotation = (Module["_EffekseerSetRotation"] =
            function () {
                return (_EffekseerSetRotation = Module[
                    "_EffekseerSetRotation"
                ] =
                    Module["asm"]["EffekseerSetRotation"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var _EffekseerGetDynamicInput = (Module["_EffekseerGetDynamicInput"] =
            function () {
                return (_EffekseerGetDynamicInput = Module[
                    ...
                    Module["asm"]["EffekseerGetDynamicInput"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetDynamicInput = (Module["_EffekseerSetDynamicInput"] =
            function () {
                return (_EffekseerSetDynamicInput = Module[
                    ...
                    Module["asm"]["EffekseerSetDynamicInput"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSendTrigger = (Module["_EffekseerSendTrigger"] =
            function () {
                return (_EffekseerSendTrigger = Module[
                    "_EffekseerSendTrigger"
                ] =
                    Module["asm"]["EffekseerSendTrigger"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetAllColor = (Module["_EffekseerSetAllColor"] =
            function () {
                return (_EffekseerSetAllColor = Module[
                    "_EffekseerSetAllColor"
                ] =
                    Module["asm"]["EffekseerSetAllColor"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetTargetLocation = (Module[
            "_EffekseerSetTargetLocation"
        ] = function () {
            return (_EffekseerSetTargetLocation = Module[
                "_EffekseerSetTargetLocation"
            ] =
                Module["asm"]["EffekseerSetTargetLocation"]).apply(
                null,
                arguments
            );
        });
        ...
        var _EffekseerSetRandomSeed = (Module["_EffekseerSetRandomSeed"] =
            function () {
                return (_EffekseerSetRandomSeed = Module[
                    "_EffekseerSetRandomSeed"
                ] =
                    Module["asm"]["EffekseerSetRandomSeed"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerGetRestInstancesCount = (Module[
            ...
            return (_EffekseerGetRestInstancesCount = Module[
                ...
                Module["asm"]["EffekseerGetRestInstancesCount"]).apply(
                null,
                arguments
            );
        });
        var _EffekseerGetUpdateTime = (Module["_EffekseerGetUpdateTime"] =
            function () {
                return (_EffekseerGetUpdateTime = Module[
                    "_EffekseerGetUpdateTime"
                ] =
                    Module["asm"]["EffekseerGetUpdateTime"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerGetDrawTime = (Module["_EffekseerGetDrawTime"] =
            function () {
                return (_EffekseerGetDrawTime = Module[
                    "_EffekseerGetDrawTime"
                ] =
                    Module["asm"]["EffekseerGetDrawTime"]).apply(
                    null,
                    arguments
                );
            });
        ...
        var _EffekseerCaptureBackground = (Module[
            "_EffekseerCaptureBackground"
        ] = function () {
            return (_EffekseerCaptureBackground = Module[
                "_EffekseerCaptureBackground"
            ] =
                Module["asm"]["EffekseerCaptureBackground"]).apply(
                null,
                arguments
            );
        });
        var _EffekseerResetBackground = (Module["_EffekseerResetBackground"] =
            function () {
                return (_EffekseerResetBackground = Module[
                    ...
                    Module["asm"]["EffekseerResetBackground"]).apply(
                    null,
                    arguments
                );
            });
        var _EffekseerSetLogEnabled = (Module["_EffekseerSetLogEnabled"] =
            function () {
                return (_EffekseerSetLogEnabled = Module[
                    "_EffekseerSetLogEnabled"
                ] =
        ...
        var _emscripten_GetProcAddress = (Module["_emscripten_GetProcAddress"] =
            function () {
                return (_emscripten_GetProcAddress = Module[
                    ...
                    Module["asm"]["emscripten_GetProcAddress"]).apply(
                    null,
                    arguments
                );
            });
...
if (
    (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ===
        "object" &&
    (typeof module === "undefined" ? "undefined" : _typeof2(module)) ===
        "object"
)
...
var effekseer = (function () {
    ...
    var _onRuntimeInitialized = function _onRuntimeInitialized() {
        ...
        Core = {
            ...
            Update: Module.cwrap("EffekseerUpdate", "void", [
                "number",
                "number",
            ]),
            BeginUpdate: Module.cwrap("EffekseerBeginUpdate", "void", [
                "number",
            ]),
            ...
            StopRoot: Module.cwrap("EffekseerStopRoot", "void", [
                "number",
                "number",
            ]),
            Exists: Module.cwrap("EffekseerExists", "number", [
                "number",
                "number",
            ]),
            ...
            SetTargetLocation: Module.cwrap(
                "EffekseerSetTargetLocation",
                "void",
                ["number", "number", "number", "number", "number"]
            ),
            GetDynamicInput: Module.cwrap(
                "EffekseerGetDynamicInput",
                "number",
            ...
            GetDrawTime: Module.cwrap("EffekseerGetDrawTime", "number", [
                "number",
            ]),
            ...
            CaptureBackground: Module.cwrap(
                "EffekseerCaptureBackground",
                "void",
                ["number", "number", "number", "number", "number"]
            ),
            ...
            SetLogEnabled: Module.cwrap("EffekseerSetLogEnabled", "void", [
                "number",
            ]),
        };
        Module.resourcesMap = {};
    ...
    var EffekseerEffect = (function () {
        ...
        _createClass(EffekseerEffect, [
            ...
            },
            {
                ...
                value: (function () {
                    var _loadFromPackage2 = _asyncToGenerator(
                        /*#__PURE__*/ _regeneratorRuntime().mark(
                            function _callee(buffer, Unzip) {
                                var unzip,
                                    meta_buffer,
                                    textDecoder,
                                    text,
                                            ...
                                            switch (
                                                ...
                                                case 0:
                                                    ...
                                                    for (
                                                        ...
                                                        dep = _step.value; // const relative_path = json.files[dep].relative_path;
                                                        _buffer =
                                                            unzip.decompress(
                                                                dep
                                                            );
                    ...
                    function _loadFromPackage(_x2, _x3) {
                        return _loadFromPackage2.apply(this, arguments);
                    }
                    return _loadFromPackage;
                })(),
            },
            {
                key: "_reload",
                ...
                value: function _update() {
                    ...
                    if (this.resources.length > 0) {
                        for (var i = 0; i < this.resources.length; i++) {
                            if (
                                !this.resources[i].isLoaded &&
                                this.resources[i].isRequired
                            ) {
                                loaded = false;
                                break;
                            }
    ...
    var EffekseerHandle = (function () {
        function EffekseerHandle(context, _native) {
        ...
        _createClass(ContextStates, [
            {
                ...
                value: function release() {
                    if (this.effekseer_vao) {
                        if (this.ext_vao) {
                            this.ext_vao.deleteVertexArrayOES(
                                this.effekseer_vao
                            );
    ...
    var EffekseerContext = (function () {
        ...
        _createClass(EffekseerContext, [
                    ...
                    if (settings) {
                        ...
                        if ("enableExtensionsByDefault" in settings) {
                            enableExtensionsByDefault =
                                settings.enableExtensionsByDefault;
                        }
                    }
                    window.gl = this._gl;
            ...
            },
            {
                ...
                value: function draw() {
                    ...
                    if (this._restorationOfStatesFlag) {
                        // Save WebGL states
                        program = this._gl.getParameter(
                            this._gl.CURRENT_PROGRAM
                        );
            ...
            },
            {
                ...
                value: function setProjectionPerspective(
                    fov,
                    aspect,
                    near,
                    far
                ) {
                    Core.SetProjectionPerspective(
                        this.nativeptr,
                        fov,
                        aspect,
                        near,
            ...
            },
            {
                ...
                value: function setProjectionOrthographic(
                    width,
                    height,
                    near,
                    far
            ...
            },
            {
                ...
                value: function setCameraLookAtFromVector(
                    position,
                    target,
                    upvec
                ) {
            ...
            },
            {
                ...
                value: function loadEffect(data) {
                    ...
                    if (typeof scale === "function") {
                        console.log(
                            "Error : second arguments is number from version 1.5"
                        );
                        effect.scale = 1.0;
                        effect.onload = scale;
                    ...
                    if (typeof data === "string") {
                        ...
                        effect.baseDir =
                            dirIndex >= 0 ? data.slice(0, dirIndex + 1) : "";
                        _loadBinFile(
                            data,
                            function (buffer) {
                                effect._load(buffer);
            ...
            },
            {
                ...
                value: function loadEffectPackage(path, Unzip) {
                    ...
                    if (typeof path === "string") {
                        ...
                        effect.baseDir =
                            dirIndex >= 0 ? path.slice(0, dirIndex + 1) : "";
                        _loadBinFile(
                            path,
                            function (buffer) {
            ...
            },
            {
                ...
                value: function play(effect, x, y, z) {
                    ...
                    return handle >= 0
                        ? new EffekseerHandle(this, handle)
                        : null;
                },
    ...
    var Effekseer = (function () {
        ...
        _createClass(Effekseer, [
            ...
            },
            {
                ...
                value: function init(webglContext, settings) {
                    console.warn(
                        "deprecated : please use through createContext."
                    );
            ...
            },
            {
                ...
                value: function setProjectionPerspective(
                    ...
                    this.defaultContext.SetProjectionPerspective(
                        fov,
                        aspect,
                        near,
                        far
            ...
            },
            {
                ...
                value: function loadEffect(path) {
                    ...
                    return this.defaultContext.loadEffect(
                        path,
                        scale,
                        onload,
                        onerror
...
P_C.Type = class extends C3.SDKTypeBase {
    ...
    _checkWebGLRendererAndInit() {
        const checkInterval = setInterval(() => {
            ...
            if (renderer && globalThis.effekseerWasmLoaded === true) {
                console.log("renderer found, wasm loaded");
    ...
    async init(renderer) {
        ...
        this.loading = true;
        console.log("[efk] init-0");
        await this.effekseerManager.initialize(
            renderer._gl
        );
        console.log("[efk] init-1");
        this.loaded = true;
        this.loading = false;
        return true;
    }
